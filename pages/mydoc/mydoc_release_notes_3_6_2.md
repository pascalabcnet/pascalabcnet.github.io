...
Range(a,b) - это неудачное моделирование конструкции a..b. В данной версии реализация будет заменена на InternalRange, который в зависимости от типов a и b будет возвращать IntRange, CharRange и т.д. IntRange ... будет реализовывать интерфейс последовательности.
