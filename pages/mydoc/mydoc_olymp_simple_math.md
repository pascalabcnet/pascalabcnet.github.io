...
При написании программы на время такой подход оптимален. Если хочется решить задачу "красивее" и создать программу, позволяющую получать суммы для n = 1000, 10000 и т.д. придется заняться анализом получаемых сумм. С этой целью получим суииы для n = 1..5.
**n = 1  S=45**
**n = 2  S=4905**
**n = 3  S=494550**
**n = 4  S=49495500**
