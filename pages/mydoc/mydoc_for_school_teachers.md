...
Но потом следует пользоваться стандартными алгоритмами, а не заставлять учеников во всех задачах использовать рукописные вортировки или рукописный поиск минимума.


Наконец, доступны следующие операции:
```pascal
...
### Динамические массивы как ссылки

Очень важно понимать, что переменная типа массив - это всего лишь ссылка на элементы массива. При присваивании друг другу переменные типа массив начинают ссылаться на одну память: 
```pascal
  var a := Arr(1,2,3);
  var b := a;
  a[0] := 666;
