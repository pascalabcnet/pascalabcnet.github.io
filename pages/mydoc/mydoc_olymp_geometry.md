...
### Входные данные
Входной файл INPUT.TXT содержит количество точек N (2 ≤ N ≤ 10000). На второй строке записаны координаты этих точек XX<sub>i</sub>i - целые числа, разделенные пробелами. При этом |XX<sub>i</sub>| ≤ 30000 и XX<sub>i</sub> < XX<sub>j</sub> при i < j.
