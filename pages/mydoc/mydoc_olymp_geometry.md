---
title: Задачи, требующие знаний из геометрии
keywords: olympiads
...
## [**ЗАДАЧА №894**](https://acmp.ru/index.asp?main=task&id_task=894) Кольцо
...
## [**ЗАДАЧА №688**](https://acmp.ru/index.asp?main=task&id_task=688) Суслик и собака
...
## [**ЗАДАЧА №602**](https://acmp.ru/index.asp?main=task&id_task=602) Точки на прямой
...
## [**ЗАДАЧА №370**](https://acmp.ru/index.asp?main=task&id_task=370) Площадь многоугольника
...
Если положить, что элементом суммы является сторона многоугольника, заданная вершинами А и В с координатами (X<sub>A</sub>,Y<sub>A</sub>) и (X<sub>B</sub>,Y<sub>B</sub>) соответственно, можно записать такой элемент в виде X<sub>A</sub> * Y<sub>B</sub> -  Y<sub>A</sub> * X<sub>B</sub>.
