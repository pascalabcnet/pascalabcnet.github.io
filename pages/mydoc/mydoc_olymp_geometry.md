...
<p>Введем обозначения: x<sub>g</sub> и y<sub>g</sub> - координаты суслика (от англ. **g**opher), x<sub>d</sub> и y<sub>d</sub> - координаты собаки (**d**og), а x и y - координаты норки. Тогда суслик спасется, если
$$4\.\left(x-x_g \right)^2+\left(y-y_g \right)^2 \le \left(x-x_d \right)^2+\left(y-y_d \right)^2$$</p>
