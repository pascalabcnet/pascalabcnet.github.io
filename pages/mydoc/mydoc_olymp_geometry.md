...
Для сумммы приходится выбирать тип `int64`. В самом деле, при заданных ограничениях на исходные данные можно получить сумму порядка |20000 - (-20000)| х 2 x 50000 = 4 млрд, что превышает отведенную для типа `integer` границу 2.1 млрд.
