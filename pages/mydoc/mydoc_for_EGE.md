...
PascalABC.NET версии ниже 3.6.2 является устаревшим и не подходит для использования в ЕГЭ. 

Рекомендуется скачивать текущую версию на сайте [текущую версию на сайте](http://pascalabc.net/ssyilki-dlya-skachivaniya).
