...
***Важно!***. Данный текст не рассматривает вопросы, связанные с сутью задачи и эффективностью алгоритмов. Он лишь описывает, как на PascalABC.NET сделать запись этих алгоритмов лучше. 
