...
5. Условная операция `if p = 0 then r[0] else r[m - p]` напоминает условный оператор, но является выражением, значение которого присваивается другой переменной. Основная идея её использования - однострочность конструкции инициализации переменной l. Сравним: 
...
Следует использовать только переменные, аналогичные описанным, и никакие другие:
