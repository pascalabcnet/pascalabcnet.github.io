...
1. Новая синтаксическая конструкция для диапазона: `a..b`. Взята из языка Kotlin.
...
2. Однооператорные программы, не требующие подключения внешних модулей и описания переменных, можно писать без begin-end:
```
